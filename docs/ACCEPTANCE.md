...
| T14 | 借入/借出/还本/收本/利息/押金归属 | ⏳ | 阶段 3 资金操作模板 |
| T15 | 房贷本息、理财赎回本金收益不混算 | ⏳ | 阶段 3 |
...
| T20–T24 | 离线队列、多标签、版本冲突、会话与依赖保护 | ⏳ | 阶段 5（base_version 检查已预留） |

## 周期、推荐

| 编号 | 用例 | 状态 |
| --- | --- | --- |
| T25–T32 | 月末闰年、农历、实例防重、推荐不污染账务 | ⏳ 阶段 3/4 |
